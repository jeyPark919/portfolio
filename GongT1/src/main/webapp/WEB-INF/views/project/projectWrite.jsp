...
<form action="${pageContext.request.contextPath}/project/projectWritePro" id="join" method="post" enctype="multipart/form-data">
...
<h3>프로젝트 공고 내용</h3>
<textarea name="p_content" placeholder="내용" maxlength="1000" cols="50" rows="20" ></textarea><br><br>

<center>
<button type="submit" value="" id="button" class="submit" style="background-color: #1842B6;">등록하기</button>
<button type="reset" value="" id="button" class="cancel" style="background-color: #1842B6;" onclick="history.back()">돌아가기</button>
</center>
</fieldset>
</form>
