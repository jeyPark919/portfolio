...
<div>
<a href="${pageContext.request.contextPath}/main/login" class="nav-item nav-link" style="font-size:15px; display: inline; color: white">로그인</a>
<a href="${pageContext.request.contextPath}/main/join" class="nav-item nav-link" style="font-size:15px; display: inline; color: white">회원가입</a>
</div>
</c:if>
<c:if test="${!empty sessionScope.id }">
<div>
${sessionScope.id}님 반갑습니다.<br>
나의 매칭 횟수 : ${sessionScope.matching}
