...
<div style="color : white; font-size: 130%; margin : 0 auto; text-align: center; vertical-align: middle;">쪽지</div>

<button type="button" class="nav-item nav-link" style="font-size:15px; border: none; color: white; background-color: #1842B6;" onclick="cls()">닫기</button>
...
<script> function cls(){ window.close(); } </script>
<!-- Template Javascript -->
