...
<div id="border">
    ...
    <div class="sidemenu">
        <button type="button" class="button button-update" style="background-color: blue;">
        	<span style="color: white;">프로젝트 찾기</span></button>
    ...
    <div class="resume-view-page">
        ...
        <div class="resume-view-wrapper">
            <div class="resume-view-container">
                <div class="resume-subject">프로젝트 제목</div>
    ...
    <div class="container">
        <div class="info-container">
            <div class="info-general">
                <div class="item name">기업명</div>
                <div class="item year">외주</div>
...
<div class="list list-education">
            <div class="item ">
                ...
                <div class="description ellipsis">2024년 2월 8일 19:46</div>
                <div class="options">
                    <div class="option">2024년 2월 8일 19:46</div>
                </div>
            </div>

                <div class="item is-singleline newcomer">
                    <div class="header">공고 마감일시</div>
                    <div class="description">2024년 2월 29일 18:00</div>
                </div>

        <div class="item is-singleline">
            <div class="header">프로젝트 시작 예정일</div>
            <div class="description">2024년 3월 1일</div>
        </div>

        <div class="item">
            <div class="header">프로젝트 종료 예정일</div>
            <div class="description ellipsis"></div>
            <div class="description">2024년 8월 31일</div>
            <div class="description ellipsis"></div>
        </div>
</div>
</div>
</div>
<input type="hidden" id="hidAplctName" value="기업명"/>
...
<div class="sign">
    <div class="message">위의 모든 기재사항은 사실과 다름없음을 확인합니다.</div>
        ...
        <div class="writer">작성자 : 기업명</div>
    <div class="warning">
        <div class="description">이 공고는 2024년 02월 13일 (화)에 최종 수정된 이력서 입니다.<br>위조된 문서를 등록하여 취업/구인활동에 이용 시 법적 책임을 지게 될 수 있습니다.<br>공티는 기업과 구직자가 등록한 문서에 대해 보증하거나 별도의 책임을 지지 않으며<br>첨부된 문서를 신뢰하여 발생한 법적 분쟁에 책임을 지지 않습니다.<br>또한 구인/구직 목적 외  다른 목적으로 이용시 공고/이력서 삭제 혹은 비공개 조치가 될 수 있습니다.</div>
    </div>
</div>
