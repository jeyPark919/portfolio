	...
	<div class="page-content">
		...
		<div class="wrapper" data-controller="components--darkmode-debugger">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td rowspan="5">회원탈퇴시 까지<br>
						<br>※ 단, 관계 법령 위반에 따른 수사, 조사 등이 진행중인 경우에는 해당 수사, 조사 종료 시 까지
							보관 하며 내부규정 혹은 관련법령에 따라 일정기간 보관됨.
						</td>
			...
			<p>
				...
				다하겠습니다<br>
				<br> - 이름 : 이동현<br> - 직위 : 개인정보보호책임자<br> - 부서 : 보안팀<br>


				- 연락처 : privacy@daangnservice.com<br>
			</p>
