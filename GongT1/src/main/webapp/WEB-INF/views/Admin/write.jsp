...
<table id="notice">
<tr><td>공지사항 작성자</td><td><input type="text" name="admin_id" id = "write" value="${sessionScope.id}" readonly></td></tr>
<tr><td>공지사항 제목</td><td><input type="text" id = "write" name="n_title"  style ="width:473px;"></td></tr>

<tr><td>공지사항 내용</td><td><textarea name="n_content" rows="20" cols="50" id = "write"></textarea></td></tr>
</table>
