...
<div id="border">
    ...
    <div class="sidemenu">
        ...
        <button type="button" class="button button-update" style="background-color: #1842B6;"><span style="color: white;">회원정보 수정</span></button>
    	...
    	<button type="button" class="button button-update" onclick="location.href='${pageContext.request.contextPath}/mypageCompany/mypageCompany5'"><span>쪽지 내역</span></button>
...
<h4>이메일</h4>
<input type="email" name="email" class="email"  maxlength="50"  value="${sessionScope.email}">
<input type="button" value="중복확인" class="dupemail" style="background-color: #1842B6; width: 100px; color: white;"><br>
<sub>※이메일을 입력해주세요.</sub>
<div class="dupdivemail"></div><br>
<h4>전화번호</h4>
<input type="text" name="phone" class="phone" maxlength="13" value="${sessionScope.phone}">
<input type="button" value="중복확인" class="dupphone" style="background-color: #1842B6; width: 100px; color: white;"><br>
<sub>※전화번호를 입력해주세요.</sub>
<div class="dupdivphone"></div><br>
<input type="submit" value="수정하기" class="submit" style="background-color: #1842B6; color: white;">
</fieldset>
</form>
